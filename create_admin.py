...
This script allows you to create admin accounts with proper validation
"""
import os
import sys
import logging
...
def create_admin(admin_data):
    ...
    try:
        ...
        admin = AdminAuthService.create_admin(db, admin_create)
        
        # Set as super admin if role is SUPER_ADMIN
...
def main():
    """Main function"""
    logger.info("🚀 Admin Management Script")
    logger.info("=" * 50)
